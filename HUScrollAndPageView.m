...
@interface HUScrollAndPageView ()<UIScrollViewDelegate>
...
@implementation HUScrollAndPageView
...
#pragma mark 在这里设置指示点的颜色
        
        //选中
        _pageControl.currentPageIndicatorTintColor = self.pageCtrlSelectedColor;
